      ...
      <div className="mt-8 w-full max-w-full">
        <div className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px]">
          ...
          {/* Contenido centrado sobre la imagen */}
           <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white space-y-4 z-10 bg-[#1B3A4B] bg-opacity-75   px-4 sm:px-6 py-4 rounded-lg w-4/5 sm:w-3/4 lg:w-1/2">
